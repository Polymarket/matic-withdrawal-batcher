...
/**
 * @dev This contract should mirror the contents of RootWithdrawalBatcher with the exception of the additional constructor argument
 *      This is to allow testing of `distributeWithdrawals` without having to run multiple chains.
 *      In a proper deployment, RootWithdrawalBatcher MUST be deployed at the same address as ChildWithdrawalBatcher such that it can receive the withdrawals
 */
contract TestRootWithdrawalBatcher is RootWithdrawalBatcherTunnel {
     ...
     * @param _childTunnel - address of contract which this contract accepts messages from
     */
